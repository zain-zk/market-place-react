...
export default function LandingPage() {
  return (
    <div className="bg-black  text-white min-h-screen font-sans">
      {/* Navbar */}
      <nav className="flex items-center    justify-between px-6 md:px-10 py-5 bg-black border-b border-green-800 sticky top-0 z-50">
        <h1 className="text-2xl md:text-3xl font-extrabold textmain text-green-500 tracking-wide cursor-pointer hover:scale-105 transition">
          FixItNow
        </h1>
        ...
        <div className="flex items-center gap-4 md:gap-6">
          <Link
            to={"/login"}
            className="bg-green-600 px-5 py-2 rounded-full text-sm md:text-lg font-medium hover:bg-green-500 hover:scale-105 transition"
          >
            Get Started
          </Link>
          <ThemeLight />
      ...
      {/* Hero Section */}
      <section className="flex flex-col md:flex-row items-center justify-between px-6 md:px-10 py-14 md:py-20 bg-gradient-to-r from-black via-green-950 to-black">
        <div className="max-w-xl">
          <h2 className="text-3xl md:text-5xl font-extrabold leading-tight text-green-400 drop-shadow-lg">
      ...
      <section className="py-16 px-6 md:px-10 bg-black">
        <h3 className="text-2xl md:text-3xl font-bold text-center text-green-400 mb-12">
          Why Choose FixItNow?
        </h3>
      ...
      {/* How It Works */}
      <section className="py-16 px-6 md:px-10 bg-gradient-to-r from-green-950 via-black to-green-950">
        <h3 className="text-2xl md:text-3xl font-bold text-center text-green-400 mb-12">
          How It Works
        </h3>
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-10 text-center">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 text-center md:text-left">
          ...
          <div>
            ...
            <div className="flex justify-center md:justify-start mt-2 space-x-4">
              <a
                href="#"
                className="text-gray-400 hover:text-green-300 transition"
              >
                FB
              </a>
              <a
